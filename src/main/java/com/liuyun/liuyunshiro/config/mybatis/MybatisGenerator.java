package com.liuyun.liuyunshiro.config.mybatis;
...
public class MybatisGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/liuyun-shiro?useUnicode=true&useSSL=false&characterEncoding=utf8");
