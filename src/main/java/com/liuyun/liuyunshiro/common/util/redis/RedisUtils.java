...
public class RedisUtils {
    ...
    /**
     * @description  通过key获取储存在redis中的value
     * @author 王栋
     * @date 2019/9/25 19:02
     * @param key key
    ...
    /**
     * @description 向redis存入key和value,并释放连接资源
     * @author 王栋
     ...
     * @param key key
     * @param str  str
     * @return java.lang.Long 成功返回 添加后value的长度 失败 返回 添加的 value 的长度 异常返回0L
     **/
     ...
     * @param key key
     * @return java.lang.Boolean true OR false
     **/
    ...
    /**
     * @description 清空当前数据库中的所有 key,此命令从不失败。
     * @author 王栋
     * @date 2019/9/25 19:10
     * @param
     * @return java.lang.String 总是返回 OK
     **/
